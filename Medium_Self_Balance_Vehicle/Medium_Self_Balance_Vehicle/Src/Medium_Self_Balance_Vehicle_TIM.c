...
{
  {
    /* Output and update for function-call system: '<Root>/Function-Call Subsystem' */
    {
      ...
      Medium_Self_Balance_Vehicle_B.REG_Access3 = TIM4->CNT;
      ...
      Medium_Self_Balance_Vehicle_B.REG_Access1 = TIM2->CNT;
      ...
      Ang_moto = 300.0 * Angle + Gyro_Y * 16.5;
      ...
      Vel_moto = 400.0 * Encoder_bias + 1.2 * rtb_Gain1_h;
