...
TARGET_PATH = "G:\Big_Big\MATLAB\STM32-MAT\STM32"
...
#                        of executable (1/0)?
MODEL                = Medium_Self_Balance_Vehicle
MODULES              = Medium_Self_Balance_Vehicle_ADC.c Medium_Self_Balance_Vehicle_TIM.c Medium_Self_Balance_Vehicle_USART.c main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MODULES_OBJ          = Medium_Self_Balance_Vehicle_ADC.obj Medium_Self_Balance_Vehicle_TIM.obj Medium_Self_Balance_Vehicle_USART.obj main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MAKEFILE             = Medium_Self_Balance_Vehicle.mk
TOOLPATH             = "|>COMPILERPATH<|"
MATLAB_ROOT          = "G:/Big_Big/MATLAB/MATLAB_2018a"
ALT_MATLAB_ROOT      = "G:/Big_Big/MATLAB/MATLAB_2018a"
MATLAB_BIN           = "G:/Big_Big/MATLAB/MATLAB_2018a/bin"
ALT_MATLAB_BIN       = "G:/Big_Big/MATLAB/MATLAB_2018a/bin"
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 DOWNLOADAPPLICATION=1 STM32CUBEMXPATHUPDATE=1 STM32CUBEMXPATH="C:\Program Files (x86)\STMicroelectronics\STM32Cube\STM32CubeMX" TARGET_INST_FULLPATH="G:\Big_Big\MATLAB\STM32-MAT\STM32" IOC_FULLPATH=".\Medium_Self_Balance_Vehicle.ioc" IT_HANDLER_OPTIM=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB             = Medium_Self_Balance_Vehiclelib.lib
MODELREF_LINK_LIBS   = 
MODELREF_LINK_RSPFILE     = Medium_Self_Balance_Vehicle_ref.rsp
MODELREF_INC_PATH         =  
...
# Additional includes 
ADD_INCLUDES = \
	-IG:/Big_Big/Simulink/STM32Cube_code/Code/Medium_Self_Balance_Vehicle \
	-IG:/Big_Big/Simulink/STM32Cube_code/Code/Medium_Self_Balance_Vehicle/Medium_Self_Balance_Vehicle_stm32 \
	-IG:/Big_Big/MATLAB/STM32-MAT/STM32/addSrc/inc \
...
%.o: $(subst ",,G:/Big_Big/MATLAB/STM32-MAT/STM32/addSrc/src)/%.cpp
	@$(CC) $(CFLAGS) $< 
	@echo ### Successfully compiled source $<
...
%.o: $(subst ",,G:/Big_Big/MATLAB/STM32-MAT/STM32/addSrc/src)/%$(SRC_FILE_EXT)
...
%.o: $(subst ",,G:/Big_Big/MATLAB/STM32-MAT/STM32/addSrc/src)/%$(ASM_FILE_EXT)
