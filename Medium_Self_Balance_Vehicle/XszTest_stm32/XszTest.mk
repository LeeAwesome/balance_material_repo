...
#                        of executable (1/0)?
MODEL                = XszTest
MODULES              = XszTest_TIM.c main.c stm32xxxx_it.c
MODULES_OBJ          = XszTest_TIM.obj main.obj stm32xxxx_it.obj 
MAKEFILE             = XszTest.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = XszTest_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -ID:/Èí¼þ/STM32/TwoWheel/simulink/Medium_Self_Balance_Vehicle  -ID:/Èí¼þ/STM32/TwoWheel/simulink/Medium_Self_Balance_Vehicle/XszTest_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IC:/MATLAB/STM32-MAT/STM32/addSrc/inc 
