function CodeDefine() { 
this.def = new Array();
this.def["XszTest_M_"] = {file: "XszTest_c.html",line:35,type:"var"};
this.def["XszTest_M"] = {file: "XszTest_c.html",line:36,type:"var"};
this.def["XszTest_step"] = {file: "XszTest_c.html",line:39,type:"fcn"};
this.def["XszTest_initialize"] = {file: "XszTest_c.html",line:46,type:"fcn"};
this.def["RT_MODEL_XszTest"] = {file: "XszTest_types_h.html",line:37,type:"type"};
...
this.def["G_TIM_Count"] = {file: "XszTest_TIM_c.html",line:35,type:"var"};
this.def["G_TIM_Conf"] = {file: "XszTest_TIM_c.html",line:38,type:"var"};
this.def["G_TIM_Handler"] = {file: "XszTest_TIM_c.html",line:39,type:"var"};
this.def["TIM2_Conf"] = {file: "XszTest_TIM_c.html",line:42,type:"var"};
this.def["TIM_PeriodElapsedCustomCallback"] = {file: "XszTest_TIM_c.html",line:49,type:"fcn"};
this.def["HAL_TIM_PeriodElapsedCallback"] = {file: "XszTest_TIM_c.html",line:66,type:"fcn"};
this.def["TIM2_ItUpFcn"] = {file: "XszTest_TIM_c.html",line:81,type:"fcn"};
this.def["TIM_ConfTypeDef"] = {file: "XszTest_TIM_h.html",line:92,type:"type"};
this.def["TIM_ChTypeDef"] = {file: "XszTest_TIM_h.html",line:105,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["XszTest_c.html"] = "../XszTest.c";
	this.html2Root["XszTest_c.html"] = "XszTest_c.html";
	this.html2SrcPath["XszTest_h.html"] = "../XszTest.h";
	this.html2Root["XszTest_h.html"] = "XszTest_h.html";
	this.html2SrcPath["XszTest_private_h.html"] = "../XszTest_private.h";
	this.html2Root["XszTest_private_h.html"] = "XszTest_private_h.html";
	this.html2SrcPath["XszTest_types_h.html"] = "../XszTest_types.h";
	this.html2Root["XszTest_types_h.html"] = "XszTest_types_h.html";
	...
	this.html2SrcPath["XszTest_External_Functions_h.html"] = "../XszTest_External_Functions.h";
	this.html2Root["XszTest_External_Functions_h.html"] = "XszTest_External_Functions_h.html";
	this.html2SrcPath["XszTest_TIM_c.html"] = "../XszTest_TIM.c";
	this.html2Root["XszTest_TIM_c.html"] = "XszTest_TIM_c.html";
	this.html2SrcPath["XszTest_TIM_h.html"] = "../XszTest_TIM.h";
	this.html2Root["XszTest_TIM_h.html"] = "XszTest_TIM_h.html";
...
var fileList = [
"XszTest_c.html","XszTest_h.html","XszTest_private_h.html","XszTest_types_h.html","rtwtypes_h.html","STM32_Config_h.html","XszTest_External_Functions_h.html","XszTest_TIM_c.html","XszTest_TIM_h.html","main_c.html","stm32xxxx_it_c.html"];
